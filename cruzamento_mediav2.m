function [new_pop] = cruzamento_mediav2(pop, n, n_populacao, prob_cruzamento, cr_min, cr_max, ct_min, ct_max, a_min, a_max, x_min, x_max)
    n_pais = sum(pop(:, n+3));%numero de pais selecionados na roleta/elitismo
    pais = zeros(n_pais, n+3);		%cria-se uma nova população auxiliar somente com os pais
    cont = 0;
	for i=1:n_populacao
    ...
    ordenado = sort(pais(:,n+2),'descend');
